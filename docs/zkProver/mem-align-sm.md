...
sidebar_label: Memory Align SM 
description: A description of the Memory Align State Machine in zkProver.
keywords:
  - docs
  - zk rollups
  - polygon wiki
...
![Schema of MLOAD Example](figures/01mem-align-schm-mld-eg.png)
...
![Schema of MSTORE example](figures/02mem-align-schm-mstr-eg.png)
