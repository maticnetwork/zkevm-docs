...
Qui `StartEpoch` e `EndEpoch` sono numeri di checkpoint tra i quali il validatore sarà attivo nel suo ruolo.  In `EndBlocker` per l'app, Heimdall prende tutti i validatori attivi e aggiorna l'attuale validatore impostato nello stato.
