...
title: Kontrak Genesis
description: Genesis Kejadian di Polygon
keywords:
  - docs
  - matic
  - polygon
...
Di sini Anda akan menemukan daftar kontrak yang disebarkan di Polygon bersama dengan alamat awal mereka, yaitu, lokasi mereka di blockchain.
...
Rantai Induk: Ethereum Mainnet

| Kontrak | [Alamat](https://etherscan.io/address/Address) |
|-----------------------|-----------------------------------------------------------------------------------------------------------------------|
