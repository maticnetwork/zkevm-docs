...
id: mapped-tokens
title: Token mappati
description: Esempi di diversi token mappati su Polygon Mainnet
keywords:
  - docs
  - matic
  - polygon
...
Se vuoi che il tuo token venga mappato, invia la tua richiesta di mappatura a https://mapper.polygon.technology/.

La tabella seguente mostra alcuni esempi di diversi token mappati sulla Mumbai testnet, tra cui, ma non solo, i seguenti:

| Nome del token | Bridge | Indirizzo della catena principale: Goerli | Catena figlio: MUMBAI |
| ----------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
La tabella seguente mostra alcuni esempi di diversi token mappati su Polygon-Mainnet, tra cui, a titolo esemplificativo ma non esaustivo:

| Nome del token | Bridge | Indirizzo della catena principale: Ethereum Mainnet | Catena figlio: rete di Polygon |
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
