---
id: mapped-tokens
title: ম্যাপ করা টোকেন
description: Polygon Mainnet এ বিভিন্ন mapped  টোকেন সম্পর্কে উদাহরণ
keywords:
  - docs
  - matic
  - polygon
...
আপনি যদি আপনার ম্যাপ করা টোকেন পেতে চান তবে https://mapper.polygon.technology/-এর মাধ্যমে আপনার ম্যাপিং করার অনুরোধ পাঠান

নিচের টেবিলে মুম্বই টেস্টনেটে বিভিন্ন ম্যাপ করা টোকেন সম্পর্কে কিছু উদাহরণ দেখানো হয়েছে, তবে শুধু এগুলোতেই সীমাবদ্ধ নয়:

| টোকেনের নাম | ব্রিজ | মূল চেইনের ঠিকানা: Goerli | চাইল্ড চেইন: মুম্বই |
| ----------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
নিচের টেবিলে Polygon-মেইননেটে বিভিন্ন ম্যাপ করা টোকেন সম্পর্কে কিছু উদাহরণ দেখানো হয়েছে, তবে শুধু এগুলোতেই সীমাবদ্ধ নয়:

| টোকেনের নাম | ব্রিজ | প্যারেন্ট চেইনের ঠিকানা: Ethereum মেইননেট | চাইল্ড চেইন: Polygon নেটওয়ার্ক |
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
