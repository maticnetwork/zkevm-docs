---
id: mapped-tokens
title: Token yang Telah Dipetakan
description: Contohnya tentang token yang berbeda dipetakan pada Polygon Mainnet
keywords:
  - docs
  - matic
  - polygon
...
Jika Anda ingin memetakan token, silakan kirim permintaan pemetaan melalui https://mapper.polygon.technology/

Tabel di bawah ini menunjukkan contoh berbagai token yang dipetakan di testnet Mumbai, termasuk tetapi tidak terbatas pada:

| Nama Token | Jembatan | Alamat Rantai Induk: Goerli | Rantai Anak: MUMBAI |
| ----------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
Jika ingin memetakan token, silakan kirim permintaan pemetaan melalui https://mapper.polygon.technology/

Tabel di bawah ini menunjukkan contoh berbagai token yang dipetakan di Mainnet Polygon, termasuk tetapi tidak terbatas pada:

| Nama Token | Jembatan | Alamat Rantai Induk: Ethereum Mainnet | Rantai Anak: Jaringan Polygon |
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
