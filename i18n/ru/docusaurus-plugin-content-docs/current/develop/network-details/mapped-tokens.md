...
description: Примеры различных токенов на карте Polygon Mainnet
keywords:
  - docs
  - matic
  - polygon
...
| Имя токена | Мост | Адрес родительской цепочки: Ethereum Mainnet | Дочерняя цепочка: сеть Polygon |
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
